...
class TEDS(object):
    ...
    def evaluate(self, pred, true):
        ...
        # Parse HTML and remove unwanted tags (e.g., tbody, body)
        parser = html.HTMLParser(remove_comments=True, encoding='utf-8')
        
        # Parse and clean prediction
        pred = html.fromstring(pred, parser=parser)
        etree.strip_tags(pred, 'tbody', 'body')  # Remove injected tags
        
        # Parse and clean ground truth
        true = html.fromstring(true, parser=parser)
        etree.strip_tags(true, 'tbody', 'body')  # Remove injected tags
        
        # Extract the first table (if exists)
        ...
        if pred_tables and true_tables:
            ...
            # Remove other injected tags (e.g., div, br)
            ...
            return 1.0 - (float(distance) / n_nodes) if n_nodes != 0 else 0.0
        else:
            return 0.0
